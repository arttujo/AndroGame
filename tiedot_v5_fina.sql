...
GRANT SELECT, INSERT, UPDATE, DELETE ON androdb.* TO dbuser09@localhost;
...
INSERT INTO LOCATION VALUES ('ESCPODS', 'Escape pods', 'The ship´s evacuation center. This is the place if there´s a major emergency or a dispute with someone, which you can´t handle otherwise');
...
INSERT INTO LOCATION VALUES ('1CORR1', 'LeveL 1 Corridor 1', 'Lower deck corridor 1. There is a room to the south. A label on the wall says: Escape pods');
...
INSERT INTO LOCATION VALUES ('EXIT', 'You lost', '');
INSERT INTO LOCATION VALUES ('EXIT2', 'You won', '');
...
INSERT INTO ITEM VALUES('MEDKIT','A Healing item','Can be used to heal yourself','MEDKIT','CAFE',TRUE,TRUE);
